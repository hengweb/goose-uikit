...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#d7e9d9", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#6d1d1d", tertiary: "#EFF4F5", text: "#6d1d1d", textDisabled: "#BDC2C4", textSubtle: "#f3efff", borderColor: "#E9EAEB", card: "#e2fbe4", gradients: {
