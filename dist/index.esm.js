...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#d7e9d9", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#e0e0e0", tertiary: "#EFF4F5", text: "#6d1d1d", textDisabled: "#BDC2C4", textSubtle: "#6d1d1d", borderColor: "#E9EAEB", card: "#e2fbe4", gradients: {
